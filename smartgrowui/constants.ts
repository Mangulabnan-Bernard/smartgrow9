...
export const TRANSLATIONS: Record<Language, any> = {
  en: {
    ...
    xpGuide: 'Point Guide',
    mixTips: 'Mixing Tips',
    crossPollinationInfo: 'Cross-Pollination Info',
    ...
    breedingTechniques: 'Breeding Techniques',
    crossPollination: 'Cross-Pollination',
    crossPollinationDesc: 'Manual pollen transfer between compatible plants. Best done in morning when flowers are fresh.',
    selectionCriteria: 'Selection Criteria',
    selectionCriteriaDesc: 'Choose parent plants with strong genetics, disease resistance, and desired traits.',
    seedCollection: 'Seed Collection & Storage',
    harvesting: 'Harvesting',
    harvestingDesc: 'Collect seeds when pods are dry but before they shatter. Use paper bags to prevent mold.',
    storageConditions: 'Storage Conditions',
    storageConditionsDesc: 'Store in cool, dry place with desiccant packets. Label with date and parent plant information.',
    germinationTips: 'Germination Tips',
    preparation: 'Preparation',
    preparationDesc: 'Some seeds need stratification (cold treatment) or scarification to improve germination.',
    optimalConditions: 'Optimal Conditions',
    optimalConditionsDesc: 'Maintain consistent moisture and temperature. Use seed starting mix for best results.',
  ...
  tl: {
    ...
    crossPollinationInfo: 'Impormasyon sa Cross-Pollination',
    ...
    breedingTechniques: 'Mga Teknik sa Pagpapadami',
    crossPollination: 'Cross-Pollination',
    crossPollinationDesc: 'Manwal na paglipat ng pollen sa pagitan ng mga kompatibleng halaman. Pinakamabuti gawin sa umaga kapag sari pa ang mga bulaklak.',
    selectionCriteria: 'Kriteria sa Pagpili',
    selectionCriteriaDesc: 'Piliin ang mga halamang magulang na may malakas na genetics, resistans sa sakit, at mga ninanais na katangian.',
    seedCollection: 'Pagkolekta at Pag-iimbak ng Bunga',
    harvesting: 'Pag-ani',
    harvestingDesc: 'Kunin ang mga binhi kapag tuyo na ang mga pods pero bago pa sila. Gamitin ang mga paper bag para maiwasan ang amag.',
    storageConditions: 'Kondisyon sa Pag-iimbak',
    storageConditionsDesc: 'Imbak sa malamig at tuyo na lugar na may desiccant packets. Lagyan ng petsa at impormasyon ng magulang halaman.',
    germinationTips: 'Mga Tip sa Pagbubuhay',
    preparation: 'Paghahanda',
    preparationDesc: 'Kailangan ng ilang binhi ang stratification (cold treatment) o scarification para mapabuti ang pagbubuhay.',
    optimalConditions: 'Optimal na Kondisyon',
    optimalConditionsDesc: 'Panatilihin ang parehas na moisture at temperatura. Gamitin ang seed starting mix para sa pinakamabuting resulta.',
