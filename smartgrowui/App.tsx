...
import DatasetScannerTest from './components/DatasetScannerTest';
import { storageService } from './services/storageService';
import { firebaseService } from './services/firebaseService';
import { DiagnosisResult, MonitoringSession, AppAlert, UserStats, Language, Page } from './types';
...
const App: React.FC = () => {
  ...
  const navItems = [
    ...
    { id: 'dataset-scanner', icon: Database, label: 'Dataset Scanner' },
    ...
    <div className="flex flex-col min-h-screen bg-slate-50 text-slate-900 pb-32 md:pb-0 md:pl-64 safe-area-inset-top safe-area-inset-bottom pwa-full-height">
      ...
      <main className="flex-1 max-w-6xl mx-auto w-full p-4 md:p-12 relative">
        ...
        {currentPage === 'scanner' && (
          <Scanner 
            lang={language}
            onResult={(res) => { setActiveDiagnosis(res); setCurrentPage('dashboard'); }}
        ...
        {currentPage === 'dataset-scanner' && <DatasetScannerTest />}
      </main>
